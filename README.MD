...
### if have invariant sites in the alignment, follow the above raxml steps to remove the invariant sites, and write down the number of invariant sites (here we have 1302)
