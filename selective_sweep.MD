...
```
#### 2. add gen_dist to INFO of vcf file
```
...
```
Tips: Use the modified _util.py_ in this scripts folder to replace the original util.py in the xpclr package xpclr folder
```
